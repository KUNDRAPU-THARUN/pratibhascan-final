...
class AcademySettingsActivity : BaseActivity() {
    ...
    private fun setupHeader() {
        findViewById<TextView>(R.id.tv_welcome_name)?.text = "Settings"
        findViewById<TextView>(R.id.tv_profile_subtitle)?.text = "App & Account configurations"
